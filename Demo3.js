            ...
            <div className="row">
                <div className="col-1">
                    <div
                        ...
                        draggable
                        onDragStart={(event) =>
                            this.onDragStart(event, "rectangle")
                        }
                    >
                        <span>Rectangle</span>
                    </div>
                    <div
                        ...
                        draggable
                        onDragStart={(event) =>
                            this.onDragStart(event, "diamond")
                        }
                    >
                        <span>Diamond</span>
                    </div>
                ...
                <div className="col-11">
                    ...
                    <Link to="/blog/jsplumb-dynamic-node-creation">
                        <Button
                            variant="primary"
                            className="btn btn-primary btn-md m-2 float-right"
                        >
                    ...
                    <div className="jsplumb-canvas-container drag-container">
                        <div
                            key={JSPLUMB_ID}
                            className="jsplumb-box droppable"
